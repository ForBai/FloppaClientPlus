...
object ExtraBlocks : Module(
    ...
    val defaultStairs = StringSelectorSetting(
        "Default Stairs", "jungle", arrayListOf(
            "birch",
            "acacia",
            "stone_brick",
            "brick",
    ...
    val defaultFence = StringSelectorSetting(
        "Default Fence", "birch", arrayListOf(
            "oak",
            "dark_oak",
            "acacia",
            "birch",
    ...
    val defaultSlab = StringSelectorSetting(
        "Default Slab", "stone", arrayListOf(
            "stone",
            "oak"
        ),
