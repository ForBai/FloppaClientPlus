...
object ChestEsp : Module(
    ...
    private val mode = StringSelectorSetting(
        "Mode",
        "Box",
        arrayListOf("Box", "Phase"),
        description = "Determines how the chest wil be visualized."
    )
    private val color =
        ColorSetting("Box Color", Color(255, 0, 0), description = "Color of the box when box mode is selected.")
    private val thickness =
        NumberSetting("Thickness", 1.0, 0.0, 5.0, 0.1, description = "Line width of the box when box mode is selected.")
