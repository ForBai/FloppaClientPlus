...
object AutoLeap : Module(
    ...
    private val brTargetName = StringSetting(
        "Br Target Name",
        description = "Name of the player you want to target during blood rush. This is only active when Custom is selected for Br target."
    )
    private val disableAfterBr =
        BooleanSetting("Disable after Br", true, description = "Disables auto leap after blood was opened.")
    private val bossTarget: StringSelectorSetting
    private val bossTargetName = StringSetting(
        "Boss Target Name",
    ...
    init {
        ...
        bossTarget = StringSelectorSetting(
            "Boss Target",
            targets[5],
            targets,
            description = "This Player will be targeted while in f7 boss."
        )
        brTarget = StringSelectorSetting(
            "Br Target",
            clearTargets[5],
            clearTargets,
            description = "This Player will be targeted during blood rush."
        )
        this.addSettings(
            brTarget,
            brTargetName,
